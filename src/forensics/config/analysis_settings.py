...
shape (flat keys, sorted) via :mod:`forensics.utils.provenance`. Flat-key
routing lives in :mod:`forensics.config.compat_analysis` (ADR-017).
"""
...
from forensics.config.compat_analysis import (
    _FLAT_TO_GROUP,
    _GROUP_ATTRS,
