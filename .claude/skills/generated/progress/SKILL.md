---
name: progress
description: "Skill for the Progress area of mediaite-ghostink. 22 symbols across 4 files."
---

# Progress

22 symbols | 4 files | Cohesion: 88%
...
| `src/forensics/features/pipeline.py` | _make_progress, _run_author_batches |
...
| `_make_progress` | Function | `src/forensics/features/pipeline.py` | 340 |
