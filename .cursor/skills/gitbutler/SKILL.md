...
- **Notion / parallel‑agent playbook add-on:** `.claude/skills/gitbutler-workflow/SKILL.md` (same under `.cursor/skills/gitbutler-workflow/`). Virtual branches vs worktrees, JSON status workflow, and links to the canonical Notion pages — **does not replace** this file.
