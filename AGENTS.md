...
This project is indexed by GitNexus as **mediaite-ghostink** (7223 symbols, 15014 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
